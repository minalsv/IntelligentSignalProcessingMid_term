...
let file1Features = ['rms', 'zcr', 'spectralCrest', 'energy'];
let lowerRight;
let lowerLeft;
let upperLeft;
let upperRight;
...
function preload() {
    ...
    mySound = loadSound('../sounds/Ex2_sound2.wav');
    ...
    if (typeof Meyda == 'undefined') {
        ...
        analyzer =
            analyzer = Meyda.createMeydaAnalyzer({
                ...
                featureExtractors: file1Features, // Add desired features
                callback: features => {
                    console.log(features);
                    lowerRight = features.rms * 1000; //0.022
                    lowerLeft = features.zcr * 10; //10
                    upperLeft = features.spectralCrest * 10; //7.9
                    upperRight = features.energy * 10; //0.5
...
function drawArcs() {
    fill(featureColors[file1Features[0]]);
    arc(200, 275, lowerLeft, lowerLeft, 0, HALF_PI);
    fill(featureColors[file1Features[1]]);
    arc(200, 275, lowerRight, lowerRight, HALF_PI, PI);
    fill(featureColors[file1Features[2]]);
    arc(200, 275, upperRight, upperRight, PI, PI + HALF_PI);
    fill(featureColors[file1Features[3]]);
